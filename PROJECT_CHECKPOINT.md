...
M034_STATUS=DESIGN_CORRECTED_PENDING_FINAL_RE_REVIEW
M035_STATUS=NOT_STARTED
NEXT_PERMITTED_ACTION=MILESTONE-034 FINAL INDEPENDENT DESIGN RE-REVIEW
```
...
**Status:** `CANDIDATE_FOR_FINAL_INDEPENDENT_DESIGN_RE_REVIEW`. Not approved. Not frozen. Does not authorize implementation.
