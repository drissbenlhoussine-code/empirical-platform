...
M034_IMPLEMENTATION_FREEZE_COMMIT=PENDING
M034_STATUS=APPROVED_AND_FROZEN
M035_STATUS=NOT_STARTED
NEXT_PERMITTED_ACTION=MILESTONE-035 SCOPE SELECTION
```
...
**Next permitted action:** MILESTONE-035 SCOPE SELECTION.
