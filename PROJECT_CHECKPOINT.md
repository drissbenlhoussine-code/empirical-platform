...
```text
LATEST_FROZEN_MILESTONE=MILESTONE-034
...
M035_DESIGN_FREEZE_COMMIT=PENDING
M035_IMPLEMENTATION_STATUS=NOT_STARTED
M035_IMPLEMENTATION_OWNER_FREEZE_STATUS=NOT_STARTED
M035_STATUS=DESIGN_APPROVED_AND_FROZEN
M036_STATUS=NOT_STARTED
NEXT_PERMITTED_ACTION=MILESTONE-035 IMPLEMENTATION MISSION
```
...
**Status:** `APPROVED_AND_FROZEN`. Implementation is not yet started.

**Next permitted action:** MILESTONE-035 IMPLEMENTATION MISSION.
