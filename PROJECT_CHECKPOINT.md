...
M031_SCOPE_STATUS=CANDIDATE_FOR_INDEPENDENT_SCOPE_REVIEW
M031_SCOPE_COMMIT=PENDING
M031_DESIGN_STATUS=NOT_STARTED
M031_IMPLEMENTATION_STATUS=NOT_STARTED
M031_STATUS=SCOPE_CANDIDATE
NEXT_PERMITTED_ACTION=MILESTONE-031 INDEPENDENT SCOPE REVIEW
```
...
- MILESTONE-031 scope selection (M030 is now APPROVED_AND_FROZEN at every stage — see Section 15 — not yet started);
