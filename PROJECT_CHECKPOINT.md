...
NEXT_PERMITTED_ACTION=MILESTONE-032 DESIGN MISSION
```
...
- MILESTONE-032 design (scope is now `APPROVED_AND_FROZEN` — see Section 19 — design not yet started);
