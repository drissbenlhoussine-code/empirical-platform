...
M032_DESIGN_STATUS=CANDIDATE_FOR_FINAL_INDEPENDENT_DESIGN_RE_REVIEW
...
M032_STATUS=DESIGN_CANDIDATE
M033_STATUS=NOT_STARTED
NEXT_PERMITTED_ACTION=MILESTONE-032 FINAL INDEPENDENT DESIGN RE-REVIEW
```
...
- MILESTONE-032 independent design review and owner design freeze (a design candidate now exists — see Section 19 — not yet reviewed or frozen);
...
**Status:** `CANDIDATE_FOR_FINAL_INDEPENDENT_DESIGN_RE_REVIEW`. Not yet re-reviewed. Not approved. Not frozen. Does not authorize implementation.
