...
- MILESTONE-031 design (scope is now APPROVED_AND_FROZEN — see Section 16 — design not yet started);
...
**Status:** `APPROVED_AND_FROZEN`. MILESTONE-031 design is now authorized. MILESTONE-031 implementation is NOT authorized until design is independently reviewed and owner-frozen.
