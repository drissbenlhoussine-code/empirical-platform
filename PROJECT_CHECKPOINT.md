...
M034_SCOPE_FREEZE_COMMIT=PENDING
...
M034_STATUS=SCOPE_APPROVED_AND_FROZEN
M035_STATUS=NOT_STARTED
NEXT_PERMITTED_ACTION=MILESTONE-034 DESIGN MISSION
```
...
**Status:** `APPROVED_AND_FROZEN`. Design and implementation are not yet started.

**Next permitted action:** MILESTONE-034 DESIGN MISSION.
