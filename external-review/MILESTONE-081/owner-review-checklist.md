...
| 4 | **Emit no monetary value at all** | Stronger than "no aggregate": the reduced rational actively destroys the magnitude. Costs auditability *within* M081 - a reader must run M080 to see the money. I judged the structural guarantee worth that cost. |
...
| 15 | R01 and my ten wrong probe assertions are recorded, not hidden | `hostile-implementation-review.md` |
