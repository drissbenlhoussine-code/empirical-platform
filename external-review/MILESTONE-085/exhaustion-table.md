...
| 15 | All mutation families detected | **EXECUTED_PASS** | 67 of 67 families detected |
...
| 28 | The changed-files list is exact | **EXECUTED_PASS** | 78 paths, identical to `git diff --name-status` |
