...
ASSERTED_RATIO_BANNER = (
    ...
    "is emitted, and M081 exposes NO field semantically labelled or "
    "authoritative as a monetary amount and provides NO monetary aggregate. "
    "That is a SEMANTIC boundary: it does NOT claim the numeric pair can never "
    "reveal anything about the underlying M080 operands, because when those "
    "operands are already coprime the reduced pair coincides with them. "
