"""Activate an existing, AUTHORIZED Campaign.
...
class ActivateCampaignCommand:
    """Request to transition an existing Campaign from AUTHORIZED to ACTIVE."""
...
class ActivateCampaignHandler:
    """Loads, activates, and persists one Campaign for one command."""
    ...
    def handle(self, command: ActivateCampaignCommand) -> SaveResult:
