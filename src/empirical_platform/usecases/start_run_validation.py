"""Start validation for an existing, NORMALIZING Run: concrete command and handler.
...
class StartRunValidationCommand:
    """Request to transition an existing Run from NORMALIZING to VALIDATING."""
...
class StartRunValidationHandler:
    """Loads, starts validation on, and persists one Run for one command."""
    ...
    def handle(self, command: StartRunValidationCommand) -> SaveResult:
        """Transition the identified Run to VALIDATING and persist it."""
