"""Suspend an existing, ACTIVE Campaign.
...
class SuspendCampaignCommand:
    """Request to transition an existing Campaign from ACTIVE to SUSPENDED."""
...
class SuspendCampaignHandler:
    """Loads, suspends, and persists one Campaign for one command."""
    ...
    def handle(self, command: SuspendCampaignCommand) -> SaveResult:
        """Transition the identified Campaign to SUSPENDED and persist it."""
