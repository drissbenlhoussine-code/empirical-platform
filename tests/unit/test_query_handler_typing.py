"""MILESTONE-028 negative/positive type-check verification for QueryHandler.

Invokes `mypy` as a subprocess against isolated fixture files under
`tests/typing_fixtures/query_handler/`, proving malformed handler shapes
...
_FIXTURES = _REPO_ROOT / "tests" / "typing_fixtures" / "query_handler"
...
@pytest.mark.parametrize(
    "fixture",
    ["wrong_method.py", "wrong_query_type.py", "wrong_result_type.py", "missing_handle.py"],
)
